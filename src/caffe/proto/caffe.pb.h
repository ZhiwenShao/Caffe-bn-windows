...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.BNParameter bn_param = 202;
  bool has_bn_param() const;
  void clear_bn_param();
  static const int kBnParamFieldNumber = 202;
...
class BNParameter : public ::google::protobuf::Message {
 public:
  ...
  bool has_shift_filler() const;
  void clear_shift_filler();
  static const int kShiftFillerFieldNumber = 2;
  const ::caffe::FillerParameter& shift_filler() const;
  ::caffe::FillerParameter* mutable_shift_filler();
  ::caffe::FillerParameter* release_shift_filler();
  void set_allocated_shift_filler(::caffe::FillerParameter* shift_filler);

  // optional bool use_global_stats = 3;
  bool has_use_global_stats() const;
  void clear_use_global_stats();
  static const int kUseGlobalStatsFieldNumber = 3;
...
class DataParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional uint32 shuffle_buffer_size = 10;
  bool has_shuffle_buffer_size() const;
  void clear_shuffle_buffer_size();
  static const int kShuffleBufferSizeFieldNumber = 10;
 ...
 private:
  ...
  inline void set_has_shuffle_buffer_size();
  inline void clear_has_shuffle_buffer_size();
...
// optional bool use_global_stats = 3;
inline bool BNParameter::has_use_global_stats() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void BNParameter::set_has_use_global_stats() {
  _has_bits_[0] |= 0x00000004u;
}
inline void BNParameter::clear_has_use_global_stats() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void BNParameter::clear_use_global_stats() {
  use_global_stats_ = false;
  clear_has_use_global_stats();
}
inline bool BNParameter::use_global_stats() const {
  // @@protoc_insertion_point(field_get:caffe.BNParameter.use_global_stats)
  return use_global_stats_;
}
inline void BNParameter::set_use_global_stats(bool value) {
  set_has_use_global_stats();
  use_global_stats_ = value;
  // @@protoc_insertion_point(field_set:caffe.BNParameter.use_global_stats)
}
...
// optional uint32 shuffle_buffer_size = 10;
inline bool DataParameter::has_shuffle_buffer_size() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void DataParameter::set_has_shuffle_buffer_size() {
  _has_bits_[0] |= 0x00000200u;
}
inline void DataParameter::clear_has_shuffle_buffer_size() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void DataParameter::clear_shuffle_buffer_size() {
  shuffle_buffer_size_ = 0u;
  clear_has_shuffle_buffer_size();
}
inline ::google::protobuf::uint32 DataParameter::shuffle_buffer_size() const {
  // @@protoc_insertion_point(field_get:caffe.DataParameter.shuffle_buffer_size)
  return shuffle_buffer_size_;
}
inline void DataParameter::set_shuffle_buffer_size(::google::protobuf::uint32 value) {
  set_has_shuffle_buffer_size();
  shuffle_buffer_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.DataParameter.shuffle_buffer_size)
}
